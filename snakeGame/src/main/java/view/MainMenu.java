...
public class MainMenu extends JPanel {
    ...
    private final PlayerCustomPanel panelPlayer1;

    /** Customization panel for player 2. */
    private final PlayerCustomPanel panelPlayer2;
    ...
    public MainMenu(GameView parent) {
        ...
        this.panelPlayer1 = new PlayerCustomPanel(Color.BLUE, new ImageIcon(Objects.requireNonNull(getClass().getResource("../../resources/controls1.png"))));
        this.add(panelPlayer1, BorderLayout.WEST);

        // create player2 customization panel
        this.panelPlayer2 = new PlayerCustomPanel(Color.RED, new ImageIcon(Objects.requireNonNull(getClass().getResource("../../resources/controls2.png"))));
        this.add(panelPlayer2, BorderLayout.EAST);
        ...
        startButton.addActionListener(e -> {
            this.parent.newGame(this.panelPlayer1.getPlayerName(),  this.panelPlayer1.getPlayerColor(),
                                this.panelPlayer2.getPlayerName(),  this.panelPlayer2.getPlayerColor(),
