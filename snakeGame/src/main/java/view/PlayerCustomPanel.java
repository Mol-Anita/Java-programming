...
public class PlayerCustomPanel extends JPanel {
     ...
     */
    public PlayerCustomPanel(Color defaultColor, ImageIcon controls) {
        // set component size
        this.setPreferredSize(new Dimension(150, 350));

        // create title for component
        JLabel playerNumberLabel = new JLabel("Játékos #" + PlayerCustomPanel.playerNumber);
        ...
        // create name input
        this.playerNameInput = new JTextField("P" + PlayerCustomPanel.playerNumber);
        ...
        PlayerCustomPanel.playerNumber++;
    }
