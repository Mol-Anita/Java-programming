                ...
                try {
                    if (game != null) {
                        ...
                        if (gameState != GameState.IN_PROGRESS) {
                            ...
                            JOptionPane.showMessageDialog(Menu.this, gameEndMessage, "Játék vége", JOptionPane.INFORMATION_MESSAGE);

                            exitGame();
                        }
                    }
                } catch (SQLException exception) {
                JOptionPane.showMessageDialog(Menu.this, "Adatbázis hiba történt! A keresett adatbázis nem elérhető vagy nem létezik.", "Hiba", JOptionPane.ERROR_MESSAGE);
                Menu.this.exitGame();
                }
            }
        });
